...
import pandas as pd
import re
df1= pd.read_csv(r'C:/Users/User/Desktop/DELL/SmartLogger/Dataset_ver2.csv',nrows=20000)
# df1= pd.read_csv(r'C:/Users/User/Desktop/DELL/SmartLogger/Ux_apps_errors.csv')

df_info=df1[df1['level']=='info']
df_err=df1[df1['level']=='error']
df_warn=df1[df1['level']=='warn']
# df_info['Address']=np.nan
df_info['Info']=np.nan
# df_info['']=np.nan
